...
// 1 ~ 10 까지 더한 결과를 리턴하는 함수 작성(함수 표현식)
const sum = function(){
    let hap = 0;
    for (let i = 0; index <11; i++) {
        hap += i;
    }
    return hap;
}
...
// 3의 배수 찾기 
// multiple(num) : num  3의 배수려면 "박수" 출력 /아닌경우 "통과"
...
multiple(7);
// multiple2(num)
// 3의 배수인 경우 박수, 9의 배수인 경우 박수 x2, / 아닌경우 "통과"
...
// pass(outline, law)
// 두 과목 합해서 120점 이상이면 합격 출력 / 한 과목이 40점 미만 불합격 출력
