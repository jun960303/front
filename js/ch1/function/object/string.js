...
//     const userTel = prompt("전화번호를 입력(Ex:000-0000-0000");
...
const info = () => {
    ...
    // email.includes("@") == 자바 contains()

    if(email.indexOf("@") == -1){//email == "@" 내가작성한 값
        alert("이메일형식이 잘 못 되었습니다.")
        info();
    }else{
        document.writeln("이메일 정보 :"+email);
    }
};
